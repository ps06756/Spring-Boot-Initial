...
public class Language extends TableImpl<LanguageRecord> {
    ...
    /**
     * The reference instance of <code>movies.language</code>
     */
    ...
    /**
     * The column <code>movies.language.language_id</code>.
     */
    ...
    /**
     * The column <code>movies.language.language_code</code>.
     */
    public final TableField<LanguageRecord, String> LANGUAGE_CODE = createField(DSL.name("language_code"), SQLDataType.VARCHAR(10), this, "");

    /**
     * The column <code>movies.language.language_name</code>.
     */
    public final TableField<LanguageRecord, String> LANGUAGE_NAME = createField(DSL.name("language_name"), SQLDataType.VARCHAR(500), this, "");
    ...
    /**
     * Create an aliased <code>movies.language</code> table reference
     */
    ...
    /**
     * Create a <code>movies.language</code> table reference
     */
    public Language() {
